...
# v11 : ajout de l'inertie — les grandes forces persistent plus longtemps.
...
def spawn_random_creature(num_nodes=13):
    nodes = []
    edges = []
...
def main():
    ...
    while running:
        ...
        # Détection de divergence : respawn si un node part trop loin
        max_pos = 20.0
