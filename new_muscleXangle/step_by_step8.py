...
EXPULSION_COEF = 0.2 # Force de propulsion lors de la contraction des membres
...
class Creature:
    ...
    # 4. PHYSIQUE DE L'EAU (Loi 1 : Traînée sur les segments)
        # for e in self.edges:
        #     n1, n2 = self.nodes[e.n_a], self.nodes[e.n_b]
        ...
        #     if speed > 0:
        #         # Force opposée au mouvement (Loi de Newton)
        #         # On multiplie par la longueur pour que les grands membres poussent plus d'eau
        #         drag_f = speed * FLUID_DENSITY
        #         n1.vx -= (avg_vx / speed) * drag_f
        #         n1.vy -= (avg_vy / speed) * drag_f
        #         n2.vx -= (avg_vx / speed) * drag_f
        #         n2.vy -= (avg_vy / speed) * drag_f
        for e in self.edges:
            n1, n2 = self.nodes[e.n_a], self.nodes[e.n_b]
            avg_vx = (n1.vx + n2.vx) / 2
            avg_vy = (n1.vy + n2.vy) / 2
