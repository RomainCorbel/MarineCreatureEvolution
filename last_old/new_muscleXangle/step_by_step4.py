import pygame
import math
# plutot qu une pause complete, on fait un coeff
# --- Config ---
...
def spawn_pince():
    pivot = Node(0, 0, is_muscle=True, amplitude=1, period=360, pause_max=True, pause_min=False, threshold=0.8, coef_pause=0)
